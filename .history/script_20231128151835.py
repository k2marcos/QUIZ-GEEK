...
btn_play = Button(root,text="PLAY",compound=CENTER,width=5, height=1,border=False,bg="#FAEA0C")
btn_play.place(x=230, y=786)
btn_play.configure(font=("Arial", 44, "italic"))

btn_quit = Button(root,text="QUIT",compound=CENTER,width=4, height=1,border=False,bg="#FAEA0C",)
btn_quit.place(x=976, y=786)
btn_quit.configure(font=("Arial", 44, "italic"))
