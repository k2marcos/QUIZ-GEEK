from tkinter import Tk, Button, Label, Canvas, BOTH, YES, NW, CENTER,Application
...
btn_quit = Button(root,text="QUIT",compound=CENTER,width=4, height=1,border=False,bg="#FAEA0C", command=lambda: Application.Quit())
